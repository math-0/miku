module.exports = {
  Admins: ["561625729436090400", "UserID"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "m.", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/Uh8Dc3KT2h", //Support Server Link
  Token: process.env.Token || "", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "977584004863758416", //Discord Client ID
  ...
  CookieSecret: "Miku love", //A Secret like a password
  IconURL:
    "https://media.discordapp.net/attachments/836702526781784196/978413457093320764/9220-cdspin.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
  ...
  Presence: {
    ...
    name: "m.help | m.invite", // The message shown
