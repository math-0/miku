...
class DiscordMusicBot extends Client {
    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          ...
          .addField("Lancer par", `${track.requester}`, true)
          .addField(
            "Durée",
      ...
      .on("queueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("La file d'attente est fini.", 
  ...
  sendError(Channel, Error) {
    let embed = new MessageEmbed()
      .setTitle("Une erreur est détécté")
      .setColor("RED")
      .setDescription(Error)
      .setFooter(
        "Si vous pensez qu'il s'agit d'un beug, veuillez le signaler dans le serveur de support !"
      );
